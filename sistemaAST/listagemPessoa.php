...
<?php include("nav-bar.php"); ?>
    ...
    <div class="container" style="background-color: rgba(0, 0, 0, 0.66); color: white">
        ...
        <div class="container" ><br><br>
            <div class="text-center border border-white rounded"><h3 class="pt-3">Pessoas cadastradas no sistema</h3>
             </div><br><br>
        </div>  
                    ...
                    if(mysqli_num_rows($resultado) > 0){
                        while($linhas = mysqli_fetch_assoc($resultado)){ ?>
                            ...
                            <tr>
                                ...
                                <td>  <?php echo converteData($linhas['dataNascimento'])?>  </td>
                                <td>  <?php echo $linhas['telefone']?>  </td>
                                <td>  <?php echo $linhas['email']?>  </td>
                                <td>  <?php echo $linhas['tipoPessoa']?>  </td>
