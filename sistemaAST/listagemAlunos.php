...
//Preparação da SQL
$sql = "select * from pessoa where tipoPessoa='AL' and status='1'";
...
<?php include("nav-bar.php"); ?>
    ...
    <div class="container" style="background-color: rgba(0, 0, 0, 0.66); color: white">
        ...
        <div class="container" ><br><br>
            <div class="text-center border border-white rounded"><h3 class="pt-3">Alunos cadastrados no sistema (ativos)</h3>
             </div><br><br>
        </div>  
