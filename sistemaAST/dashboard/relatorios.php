...
<header class="bg-dark text-center py-5 mb-4">
  <div class="container">
    <h1 class="font-weight-light text-white text-center">Selecione o Relatório</h1>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <a href="../listagemAlunos.php"><img src="img/listagemAlunos.png" class="card-img-top" alt="..."></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Relatório de Alunos (ativos)</h5>
        </div>
      </div>
    </div>
    <!-- Team Member 2 -->
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <a href="../listagemFuncionarios.php"><img src="img/listagemFuncionarios.png" class="card-img-top" alt="..."></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Relatório de Funcionários (ativos)</h5>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <a href="../listagemAlunosInativos.php"><img src="img/listagemAlunosInativos.jpg" class="card-img-top" alt="..."></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Relatório de Alunos (inativos)</h5>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <a href="../listagemFuncionariosInativos.php"><img src="img/listagemFuncionariosInativos.jpg" class="card-img-top" alt="..."></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Relatório de Funcionários (inativos)</h5>
        </div>
      </div>
    </div>
