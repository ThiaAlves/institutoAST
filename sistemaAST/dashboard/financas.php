...
<header class="bg-dark text-center py-5 mb-4">
  <div class="container">
    <h1 class="font-weight-light text-white text-center">Bem-vindo ao menu de Finanças</h1>
  </div>
</header>
  ...
  <div class="row">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <a href="../listagemRecebimento.php"><img src="img/recebimento.jpg" class="card-img-top" alt="..."></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Últimos Recebimentos</h5>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-0 shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Mensalidades Pagas</h5>
        </div>
      </div>
    </div>
  </div>
